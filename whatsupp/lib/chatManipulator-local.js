...
// module.exports = function ChatManipulator(text){
//   var names = [];
//   var personOneMessages = [];
//   var personTwoMessages = [];
//
...
//     // console.log(personOneMessages);
//
//     sendToAPI(personOneMessages, personTwoMessages);
//   };
//
//   sendToAPI = function(sideOne, sideTwo){
//     // console.log("AAAAAAAAAAAA", sideOne, sideTwo)
//     console.log("AAAAAAAAAAAAAA")
//
//     // textAPI.aspectBasedSentiment(sideOne);
//     // textAPI.aspectBasedSentiment(sideTwo);
//   };
//
//   readFile(text);
// };
